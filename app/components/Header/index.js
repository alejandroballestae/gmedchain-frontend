            ...
            <Grid
                ...
                <Grid item lg={3} sm={5} xs={5}>
                    <ul className="headerRight d-none">
                        ...
                        <li>{ localStorage.getItem('token') && localStorage.getItem('token').length >10 ? <Link to={localStorage.getItem('type')=='Buyer'?"/dashboard":(localStorage.getItem('type')=='Seller'?"/supplier-dashboard":"/shipper-dashboard")}><Button className="btn">Dashboard</Button></Link>:<Link to="/login"><Button className="btn">Login</Button></Link>}</li>
                    </ul>
                    <Menu
                        anchorEl={openSearch}
                        keepMounted
