                            ...
                            <Grid className="blogGridContent">
                                <Grid className="authorBox">
                                    <Grid className="authorContent" container>
                                        <Grid item md={5} xs={2}>
                                            <h4>Verifie By Email</h4>
                                            <p>If your email is still in use, please choose this way</p>
                                            <ul className="socialLink">
                                            </ul>
                                        </Grid>
                                        <Grid item md={5} xs={2} style={notItem} ><Switch  checked inputProps={{ 'aria-label': 'primary checkbox' }} /></Grid>
                                    </Grid>
                                </Grid>
                            </Grid>
                        </Grid>
